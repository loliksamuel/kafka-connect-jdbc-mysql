...
kafka-log-dirs --describe --bootstrap-server 0.0.0.0:9092 --topic-list  docker-connect-offsets
kafka-configs  --describe --zookeeper zookeeper:2181 --entity-type topics
kafka-consumer-perf-test --topic benchmark-3-3-none --zookeeper kafka-zk-1:2181,kafka-zk-2:2181,kafka-zk-3:2181 --messages 15000000 --threads 1
kafka-producer-perf-test  --topic benchmark-1-1-none \
